...
public class RemoteDriverTest {
	...
	/*
	 * To set up the Selenium Hub, open command prompt, and navigate to the
	 * directory where the Selenium Server Standalone jar file is stored (downloaded
	 * in Step 1). java -jar selenium-server-standalone-3.141.59.jar -role hub java
	 * -Dwebdriver.chrome.driver="chromedriver.exe" -jar
	 * selenium-server-standalone-3.141.59.jar -role node -hub
	 * http://192.168.43.53:4444/grid/register/
	 *
	 */
}
